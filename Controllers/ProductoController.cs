...
namespace tiendajuegos.Controllers
{
    ...
    public async Task<IActionResult> ListarRegistroProducto()
        ...
        public async Task<IActionResult> RegistrarProducto([Bind("id,name,category,price,desc")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditarProducto(int id, [Bind("id,name,category,price,desc")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
